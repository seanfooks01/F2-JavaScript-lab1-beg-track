...
var i = Math.floor(Math.random() * favoriteAnimals.length);
...
assert(animalExhiibitStats.numberOpen === 13, 'there should be 13 open exhibits');
...
assert(animalExibitStats.mostPopular, 'Lucky the Emperor Penguin', 'What gives!')
